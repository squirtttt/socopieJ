...
namespace VREasy
{
    ...
    public class VRGUIScrollbar: VRSelectable
    {
        public Scrollbar UnityScrollbar
        {
            get
            {
                if (unityScrollbar == null)
                    unityScrollbar = GetComponent<Scrollbar>();
                return unityScrollbar;
            }
            set
            {
                unityScrollbar = value;
            }
        }
        private Scrollbar unityScrollbar;
